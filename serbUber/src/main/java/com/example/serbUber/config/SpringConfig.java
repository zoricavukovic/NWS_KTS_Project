...
public class SpringConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .permitAll()
            .antMatchers("/drivings/{email}/{pageNumber}/{pageSize}/{parameter}/{sortOrder}")
            .permitAll()
            ...
            .permitAll()
            .antMatchers("/reviews/reviewedDrivings/{email}")
            .permitAll()
            .antMatchers("/regularUsers/favourite")
            .permitAll()
            .antMatchers("/regularUsers/removeFavourite")
            .permitAll()
            .antMatchers("/regularUsers/favouriteRoute/{id}/{email}")
            .permitAll()
            .anyRequest()
            .authenticated()
            .and()
