...
public class EmailService {
    ...
    @Async
    public void sendVerificationMail(int verificationCode, String verificationUrl) throws MailException, IOException {
        ...
        mm.sendMail("serbUberNWTKTS@gmail.com", "serbUberNWTKTS@gmail.com", SUBJECT_VERIFY_USER, emailTemplate);
    }

    @Async
    public void sendBlockDriverMail(String email, String reason) throws IOException {
        ...
        mm.sendMail("serbUberNWTKTS@gmail.com", "serbUberNWTKTS@gmail.com", SUBJECT_BLOCK, emailTemplate);
    }

    @Async
    public void sendResetPasswordMail(String email, String resetPasswordUrl) throws IOException {
        ...
        mm.sendMail("serbUberNWTKTS@gmail.com", "serbUberNWTKTS@gmail.com", SUBJECT_REST_PASSWORD, emailTemplate);
    }
