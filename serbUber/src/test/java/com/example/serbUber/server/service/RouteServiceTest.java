...
import static com.example.serbUber.server.helper.LocationConstants.*;
...
public class RouteServiceTest {
    ...
    private SortedSet<DrivingLocationIndex> createDrivingLocationIndex() {
    ...
    private Route createTestRoute(final SortedSet<DrivingLocationIndex> drivingLocationIndexList, final double time, final double distance) {

        return new Route(drivingLocationIndexList, distance, time);
    }

    private List<DrivingLocationIndexRequest> createDrivingLocationIndexRequests() {
